...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt->bind_param("ssssssssissssiiiidddssidd", $section, $courseID, $userid, $time_start_lec, $time_end_lec, $time_start_lab, 
                        $time_end_lab, $course_day, $course_week, $weeks_selected, $std_faculty, $std_department, $std_degree, $std_enroll, $std_per_week, 
                        $year, $term, $hpw_bachelor, $hpw_inter_bachelor, $hpw_graduate,$workload_for_reimbursement, $remark, $amount_wpt, 
                        $amount_hpt, $amount_teach_hpt
                    );
